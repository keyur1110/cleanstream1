    ...
    RGraph.Rose = function (conf)
    {
        ...
        */
        ...
        this.properties =
        {
            ...
            'chart.background.grid.count':  10,
            'chart.centerx':                null,
            'chart.centery':                null,
            'chart.radius':                 200,
            ...
            'chart.gutter.top':             25,
            'chart.gutter.bottom':          0,
            'chart.title':                  '',
            'chart.title.background':       '#fff',
            ...
            'chart.text.font':              '"Bitter",serif',
            'chart.text.size':              14,
            'chart.key':                    null,
            'chart.key.background':         'red',
            'chart.key.position':           'graph',
            'chart.key.halign':             'right',
            'chart.key.shadow':             true,
            'chart.key.shadow.color':       '#000',
